...
print '<p><a href="index.php">Latest</a> <-> <a href="index.php?random=true">Random</a> <-> <a href="index.php?favorite=true">Favorite</a> <-> <a href="login.php">Login</a></p>';

include(dirname(__DIR__).'/quotesApp/templates/footer.php'); // Include the footer.
?>