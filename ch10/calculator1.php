...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (is_numeric($_POST['quantity']) and is_numeric($_POST['price'])) {
            ...
            print print '<p style="color: red;">Please enter a valid quantity and price!</p>';
        }
    }
    ?>
    ...
    <form action="" method="post">
        ...
        <p>Price: <input type="text" name="price" size="5"></p> <input type="submit" name="submit" value="Calculate!">
    </form>
</body>
